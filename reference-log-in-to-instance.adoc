...
summary: En ocasiones, es posible que necesite iniciar sesión en el sistema de NetApp Data Classification para poder acceder a los archivos de registro o editar los archivos de configuración. 
---
= Inicia sesión en NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
