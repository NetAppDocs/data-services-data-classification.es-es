...
* https://docs.netapp.com/us-en/console-setup-admin/reference-ports-aws.html["Reglas de grupo de seguridad en AWS"^]
* https://docs.netapp.com/us-en/console-setup-admin/reference-ports-azure.html["Reglas de grupo de seguridad en Azure"^]
* https://docs.netapp.com/us-en/console-setup-admin/reference-ports-gcp.html["Reglas de firewall en Google Cloud"^]
