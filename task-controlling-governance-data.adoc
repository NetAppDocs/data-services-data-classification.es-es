...
.Pasos
. Desde el menú de la consola de NetApp , seleccione *Gobernanza > Clasificación*.
...
.Pasos
. En el gráfico Era de los Datos, para ver detalles sobre la antigüedad de los datos, coloque el cursor sobre un punto del gráfico.
