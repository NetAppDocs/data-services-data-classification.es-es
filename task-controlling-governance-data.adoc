...
summary: Con NetApp Data Classification, puedes reducir los costes de almacenamiento identificando datos obsoletos, archivos duplicados y archivos grandes, y luego eliminarlos o moverlos a un almacenamiento de objetos más económico 
---
= Consulta los detalles de gobernanza sobre los datos de la organización con NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Dentro de cada mosaico de Savings Opportunities del panel de control de Governance, selecciona *Optimize Storage* para ver los resultados filtrados en la página de Investigation. Para descubrir cualquier dato que deberías eliminar o asignar a un almacenamiento menos costoso, investiga las _Saving Opportunities_.
+
...
.Pasos
. En Clasificación de datos, seleccione *Gobernanza*.
. En el mosaico de informes, selecciona el botón **Descargar** en el encabezado del informe Full data mapping overview.
+
