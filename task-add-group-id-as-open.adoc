...
summary: 'Cuando los identificadores de grupo se adjuntan a archivos o carpetas en recursos compartidos de archivos NFS, definen los permisos para el archivo o la carpeta. Si los identificadores de grupo no están configurados con el nivel de permiso "Abierto a la organización", puedes agregar ese permiso al GID para que todos los archivos y carpetas que tengan ese GID adjunto se consideren "abiertos a la organización".' 
---
