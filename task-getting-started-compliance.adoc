...
* Asegúrate de que exista una conexión de red entre la instancia de Data Classification y cada red que incluya volúmenes de Cloud Volumes ONTAP o clústeres ONTAP locales.
...
NOTE: La función de clasificación de datos solo analiza un recurso compartido de archivos dentro de un volumen. Si tienes varios recursos compartidos en tus volúmenes, necesitas analizar esos otros recursos compartidos por separado como un grupo de recursos compartidos. link:reference-limitations.html#data-classification-scans-only-one-share-under-a-volume["Ver más detalles sobre esta limitación de clasificación de datos"^].
