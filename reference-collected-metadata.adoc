...
Si es necesario, puede exportar estos resultados a un informe para ver qué archivos se están escaneando o no debido a los permisos. link:task-investigate-data.html#data-investigation-report["Obtenga más información sobre el Informe de investigación de datos"^] .
