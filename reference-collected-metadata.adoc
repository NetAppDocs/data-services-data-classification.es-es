...
Si es necesario, puede exportar estos resultados a un informe para ver qué archivos se están escaneando o no debido a los permisos. link:task-investigate-data.html#download-your-report["Obtenga más información sobre los informes de investigación de datos"^].
