...
Para entrar a Swagger, necesitas la dirección IP de tu instancia de Data Classification. En el caso de un despliegue en la nube, usarás la dirección IP pública. Luego necesitas entrar a este endpoint:
