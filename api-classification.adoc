...
summary: Las capacidades de clasificación de datos de NetApp disponibles a través de la interfaz de usuario web también están disponibles a través de la API. 
---
= API de clasificación de datos de NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Las capacidades de clasificación de datos de NetApp disponibles a través de la interfaz de usuario web también están disponibles a través de la API REST.
...
Las API en la documentación de Swagger le permiten buscar, agregar datos, rastrear sus escaneos y realizar acciones como copiar, mover y más.
...
Puedes aplicar una acción en varios elementos.  Los tipos de acciones admitidos incluyen: mover, eliminar y copiar.
