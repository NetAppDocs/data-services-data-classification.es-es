...
** Para habilitar el escaneo completo en un volumen, en el área de volumen, seleccione *Mapear y clasificar*.  Para habilitarlo en todos los volúmenes, en el área de encabezado, seleccione *Mapa y clasificar*.
