...
Si el sistema de Azure NetApp Files que desea escanear aún no se encuentra en la consola de NetApp como sistema,link:https://docs.netapp.com/us-en/bluexp-azure-netapp-files/task-quick-start.html["agréguelo en la página de Sistemas"^] .
