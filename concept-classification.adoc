...
https://bluexp.netapp.com/netapp-cloud-data-sense["Conozca los casos de uso para la clasificación de datos"^] .
...
Cuando implementa la clasificación de datos en la nube, la consola implementa la instancia en la misma subred que el agente de la consola. https://docs.netapp.com/us-en/bluexp-setup-admin/concept-connectors.html["Obtenga más información sobre el agente de consola."^]
