...
---
= Investiga los datos de tu organización con NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
El panel de control de Investigación de datos muestra información a nivel de archivo y directorio sobre tus datos, permitiéndote ordenar y filtrar los resultados. La página de Investigación de datos presenta información sobre metadatos y permisos de archivos y directorios, además de identificar archivos duplicados. Con información a nivel de archivo, directorio y base de datos, puedes tomar acciones para mejorar el cumplimiento de tu organización y ahorrar espacio de almacenamiento. La página de Investigación de datos también admite link:task-copy-move.html["mover, copiar y borrar archivos"].


NOTE: Para obtener información de la página Investigación, debes realizar un análisis de clasificación completo de tus fuentes de datos. Las fuentes de datos que se han sometido a un análisis solo de mapa no muestran detalles a nivel de archivo.
...
| Número de identificadores | Selecciona el rango de identificadores sensibles detectados por archivo. Incluye datos personales y datos personales sensibles. Al filtrar en directorios, Data Classification suma las coincidencias de todos los archivos de cada carpeta (y subcarpetas). NOTA: La versión de diciembre de 2023 (versión 1.26.6) eliminó la opción de calcular el número de datos de información de identificación personal (PII) por directorios. 
...
TIP: Después de filtrar los datos, puedes link:task-copy-move.html["copiar, mover y eliminar archivos no estructurados"] para mejorar el cumplimiento o optimizar el almacenamiento.
...
* link:task-copy-move.html["Copiar, mover y eliminar datos desde el panel de control de Investigation"]
