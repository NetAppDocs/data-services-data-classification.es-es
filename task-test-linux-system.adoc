...
El script de instalación de Data Classification incluye un script de prueba para garantizar que tu entorno cumple los requisitos. Puedes ejecutar este script por separado para verificar que el host Linux está listo antes de ejecutar el script de instalación.
