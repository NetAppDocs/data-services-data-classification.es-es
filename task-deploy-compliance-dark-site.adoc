...
[role="lead"]
Utiliza el _modo privado_ para instalar NetApp Data Classification en un host Linux en un sitio local sin acceso a internet. Esta implementación utiliza un script de instalación y mantiene la instancia de Data Classification desconectada de la capa SaaS de NetApp Console, lo que te permite analizar fuentes de datos locales en un entorno aislado.
