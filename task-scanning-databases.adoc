...
TIP: No existe la opción de seleccionar exploraciones solo de mapas para esquemas de bases de datos.

. En la página Configuración, selecciona el botón *Gestionar* de la base de datos que quieres configurar.
+
...
. Para cada esquema para el que quieras activar los escaneos, selecciona la columna *Tipo de escaneo* y luego configura el escaneo como desactivado o **Escaneo completo**.
