...
summary: Para instalar NetApp Data Classification en un host Linux en tu red o en un host Linux en la nube que tenga acceso a internet, necesitas desplegar el host Linux manualmente en tu red o en la nube. 
---
= Instala NetApp Data Classification en un host con acceso a internet
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Para desplegar NetApp Data Classification en un host Linux en tu red o en un host Linux en la nube que tenga acceso a internet, necesitas desplegar el host Linux manualmente en tu red o en la nube.
...
Si aún no tienes un agente de consola, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-on-prem.html["Implementar el agente de consola localmente"^] en un host Linux en su red o en un host Linux en la nube.
...
Se requiere un agente de Consola antes de que puedas instalar y usar NetApp Data Classification. En la mayoría de los casos, probablemente ya tendrás un agente de Consola configurado antes de intentar activar NetApp Data Classification.
...
En la mayoría de las situaciones, instalas Data Classification en un sistema de un solo host. Esto no es el mismo host de máquina virtual que el agente de la Console. <<Instalación de un solo host para configuraciones típicas,Vea esos pasos aquí>>.
...
.Pasos
. Descarga el software de Data Classification desde el https://mysupport.netapp.com/site/products/all/details/cloud-data-sense/downloads-tab/["Sitio de soporte de NetApp"^]. Selecciona el archivo llamado *DATASENSE-INSTALLER-<version>.tar.gz*.
