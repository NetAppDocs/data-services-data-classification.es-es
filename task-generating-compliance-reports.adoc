...
summary: La clasificación de datos de NetApp proporciona informes que puede utilizar para comprender mejor el estado del programa de privacidad de datos de su organización. 
---
= Ver informes de cumplimiento de clasificación de datos de NetApp
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
La clasificación de datos de NetApp proporciona informes que puede utilizar para comprender mejor el estado del programa de privacidad de datos de su organización.
...
* *Informe de evaluación de descubrimiento de datos*: proporciona un análisis de alto nivel del entorno escaneado para resaltar los hallazgos del sistema y mostrar áreas de preocupación y posibles pasos de remediación.
* *Informe de mapeo de datos*: proporciona información sobre el tamaño y la cantidad de archivos en sus sistemas.  Esto incluye la capacidad de uso, la antigüedad de los datos, el tamaño de los datos y los tipos de archivos.
* *Informe de solicitud de acceso del interesado*: le permite extraer un informe de todos los archivos que contienen información sobre el nombre específico o un identificador personal del interesado.
* *Informe HIPAA*: le ayuda a identificar la distribución de información de salud en sus archivos.
* *Informe PCI DSS*: le ayuda a identificar la distribución de la información de tarjetas de crédito en sus archivos.
* *Informe de evaluación de riesgos de privacidad*: proporciona información sobre la privacidad de sus datos y una puntuación de riesgo de privacidad.
...
. Desde la página de Cumplimiento, seleccione *Sujetos de datos*.
. Buscar el nombre completo del interesado o un identificador conocido.
+
A continuación se muestra un ejemplo que muestra una búsqueda del nombre _john doe_:

+
image:screenshot_dsar_search.gif["Captura de pantalla de la búsqueda del interesado."]

. Elija una de las opciones disponibles:
+
** *Descargar Informe DSAR*: Una respuesta formal a la solicitud de acceso que puede enviar al interesado.  Este informe contiene información generada automáticamente en base a los datos que Data Classification encontró sobre el interesado y está diseñado para usarse como plantilla.  Debe completar el formulario y revisarlo internamente antes de enviarlo al titular de los datos.
** *Investigar resultados*: una página que le permite investigar los datos buscando, ordenando, expandiendo detalles de un archivo específico y descargando la lista de archivos.
+

NOTE: Si hay más de 10.000 resultados, solo los 10.000 primeros aparecen en la lista de archivos.
