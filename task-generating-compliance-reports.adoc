...
---
= Consulta los informes de conformidad en NetApp Data Classification
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[NOTE]
====
* Los informes de cumplimiento solo están disponibles si realizas un escaneo de clasificación completo en tus fuentes de datos. Las fuentes de datos que han tenido un escaneo solo de mapa solo pueden generar el informe de mapeo de datos.
