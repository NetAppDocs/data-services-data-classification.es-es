...
summary: 'NetApp proporciona soporte para la consola NetApp de distintas maneras. Siempre hay disponibles amplias opciones de autoayuda gratuitas, como artículos de la base de conocimientos (KB) y un foro comunitario. Su registro de soporte incluye soporte técnico remoto mediante tickets web.' 
---
= Obtenga ayuda para la clasificación de datos de NetApp
:allow-uri-read: 
:icons: font
:imagesdir: ./media/
